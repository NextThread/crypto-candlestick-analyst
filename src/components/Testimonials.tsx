      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {testimonials.map((testimonial) => (
            ...
            >
              <div>
                <div className="absolute top-0 right-0 w-20 h-20 bg-primary/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-xl"></div>
                <div className="mb-6">
                  <svg width="45" height="36" className="text-primary/30 mb-4" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
